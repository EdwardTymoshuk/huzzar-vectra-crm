...
import { Prisma, WarehouseAction, WarehouseItemType } from '@prisma/client'
...
export const historyRouter = router({
  ...
  getWarehouseHistory: adminCoordOrWarehouse
    ...
    .query(async ({ input }) => {
      ...
      const whereBase: Prisma.WarehouseHistoryWhereInput = {
        action: actions?.length
          ...
          : {
              notIn: [
                WarehouseAction.ISSUED_TO_CLIENT,
                WarehouseAction.ASSIGNED_TO_ORDER,
              ],
            },
        NOT: {
          AND: [
