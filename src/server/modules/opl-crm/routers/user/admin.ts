...
export const adminUserRouter = router({
  ...
  getUserById: adminOnly
    ...
    .query(async ({ ctx, input }) => {
      const user = await ctx.prisma.oplUser.findUnique({
