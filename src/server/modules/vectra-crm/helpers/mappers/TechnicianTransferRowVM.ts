// src/server/modules/vectra-crm/helpers/mappers/TechnicianTransferRowVM.ts
...
import { UserVM, mapVectraUserToVM } from './mapVectraUserToVM'
...
export const mapTechnicianTransferToVM = (
  ...
  return {
    ...
    transferTo: mapVectraUserToVM(item.transferTo),
    assignedTo: mapVectraUserToVM(item.assignedTo),
    incoming,
  }
}
