...
import { OperatorDefinition } from '@prisma/client'
...
const OperatorDefinitionsList: FC = () => {
  ...
  const [editingItem, setEditingItem] = useState<OperatorDefinition | null>(
    null
  )

  const utils = trpc.useUtils()
  const deleteMutation = trpc.operatorDefinition.deleteDefinition.useMutation({
    onSuccess: () => {
      toast.success('Operator został usunięty.')
      utils.operatorDefinition.getAllDefinitions.invalidate()
    },
