...
import { getSettlementWorkCodes } from '@/app/(modules)/vectra-crm/utils/getSettlementWorkCodes'
                    ...
                    >
                      ...
                      <div className="text-sm text-muted-foreground ml-2 mt-1 space-y-1">
                        ...
                        <div className="leading-tight">
                          {(() => {
                            const category = s.deviceType ?? 'OTHER'
                        ...
                        {s.deviceId2 && (
                          <div className="leading-tight">
                            {(() => {
                              const category = s.deviceType2 ?? 'OTHER'
                              const name = s.deviceName2
