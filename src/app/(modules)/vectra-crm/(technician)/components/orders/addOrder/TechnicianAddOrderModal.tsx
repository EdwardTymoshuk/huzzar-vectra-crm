...
import { VectraOrderCreatedSource, VectraOrderStatus } from '@prisma/client'
...
import { OrderFormFields } from '@/app/(modules)/vectra-crm/components/orders/OrderFormFields'
...
import { TechnicianVectraOrderFormData } from '@/types/vectra-crm'
...
export const TechnicianAddOrderModal = ({
  ...
  const createOrderMutation = trpc.vectra.order.createOrder.useMutation()
  ...
  const onSubmit = async (data: TechnicianVectraOrderFormData) => {
    ...
    try {
      const createdOrder = await createOrderMutation.mutateAsync({
        ...
        createdSource: VectraOrderCreatedSource.MANUAL,
      })
