...
const GenerateBillingReportDialog = ({
  ...
  const technicianReportMutation =
    trpc.vectra.settlement.generateTechnicianMonthlyReport.useMutation()
  const monthlySummaryMutation =
    trpc.vectra.settlement.generateTechniciansMonthlySummary.useMutation()
  const codeBreakdownMutation =
    trpc.vectra.settlement.generateWorkCodeSummaryReport.useMutation()
  const yearlyTemplateMutation =
    trpc.vectra.settlement.generateYearlyInstallationReport.useMutation()
  const monthlyTemplateMutation =
    trpc.vectra.settlement.generateMonthlyInstallationReport.useMutation()
  const monthlyTechnicianTemplateMutation =
    trpc.vectra.settlement.generateMonthlyInstallationReportForTechnician.useMutation()
