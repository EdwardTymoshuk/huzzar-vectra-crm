...
const EmployeesTable = ({ searchTerm, status }: Props) => {
  ...
  const refreshLists = async () => {
    await Promise.all([
      utils.vectra.user.getTechnicians.invalidate({ status: 'ACTIVE' }),
      utils.vectra.user.getTechnicians.invalidate({ status: 'SUSPENDED' }),
      utils.vectra.user.getTechnicians.invalidate({ status: 'INACTIVE' }),
