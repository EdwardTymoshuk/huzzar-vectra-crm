...
import CompleteOrderWizard from '@/app/(modules)/vectra-crm/(technician)/components/orders/completeOrder/CompleteOrderWizard'
import EditOrderModal from '@/app/(modules)/vectra-crm/admin-panel/components/orders/EditOrderModal'
import {
  orderTypeMap,
  timeSlotMap,
...
const OrderDetailsSheet = ({ orderId, onClose, open }: Props) => {
  ...
  const deleteMutation = trpc.vectra.order.deleteOrder.useMutation({
    onSuccess: () => {
