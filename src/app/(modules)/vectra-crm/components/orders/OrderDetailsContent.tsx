...
/**
 * Order details view model used by OrderDetailsContent.
...
export type OrderWithDetails = {
  ...
  services: {
    ...
    deviceType2: VectraDeviceCategory | null
    serialNumber: string | null
    serialNumber2: string | null
    deviceSource: VectraDeviceSource | null
    extraDevices?: {
      id: string
      name: string | null
      serialNumber: string | null
      category: VectraDeviceCategory | null
      source: VectraDeviceSource | null
    }[]
  }[]
      ...
      <Section
        ...
        list={collected.map((e) => {
          ...
          const prefix = showCat
            ? devicesTypeMap[
                (e.warehouse.category || 'OTHER') as VectraDeviceCategory
              ]
            : ''
