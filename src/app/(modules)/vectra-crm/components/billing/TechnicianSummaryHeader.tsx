...
import EarningsBadgeWithBar from '@/app/(modules)/vectra-crm/components/dashboard/EarningsBadgeWithBar'
import EfficiencyBadgeWithBar from '@/app/(modules)/vectra-crm/components/dashboard/EfficiencyBadgeWithBar'
