...
import OplTechSuccessChart from './OplTechSuccessChart'
...
const OplTechOrderStatsSection = ({ date, range, data, successData }: Props) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 mb-4 h-auto">
      ...
      <div className="w-full lg:w-2/3 h-auto">
        <OplTechSuccessChart date={date} range={range} data={successData} />
      </div>
    </div>
  )
}

export default OplTechOrderStatsSection
