...
import TechnicianOplCompletedOrderDetails from './TechnicianOplCompletedOrderDetails'
...
type OrderRow = Prisma.OplOrderGetPayload<{
  select: {
    id: true
    orderNumber: true
    type: true
...
const TechnicianOplOrdersTable = ({
  searchTerm,
  autoOpenOrderId,
  onAutoOpenHandled,
  statusFilter,
  ...
  const {
    ...
    isLoading,
    isError,
  } = trpc.opl.order.getTechnicianRealizedOrders.useQuery({
    page,
    limit: perPage,
                  ...
                  <AccordionItem key={o.id} value={o.id} className="min-w-fit">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <span>{oplOrderTypeMap[o.type]}</span>
...
export default TechnicianOplOrdersTable
