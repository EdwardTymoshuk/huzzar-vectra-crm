...
type FilterProps = {
  statusValue: OplOrderStatus | null
  typeValue: OplOrderType | null
  setStatusFilterAction: (status: OplOrderStatus | null) => void
  setOrderTypeFilterAction: (type: OplOrderType | null) => void
  onClearAction: () => void
}
 ...
 */
export const TechnicianOplOrdersFilter = ({
  statusValue,
  typeValue,
