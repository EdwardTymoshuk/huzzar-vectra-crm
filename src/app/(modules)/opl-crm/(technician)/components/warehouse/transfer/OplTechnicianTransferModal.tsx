...
import TransferItemsTabs from '@/app/(modules)/opl-crm/components/warehouse/OplTransferItemsTabs'
 ...
 */
const OplTechnicianTransferModal = ({ open, onClose }: Props) => {
...
export default OplTechnicianTransferModal
