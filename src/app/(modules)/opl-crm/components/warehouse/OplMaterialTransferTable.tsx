...
type Props = {
  ...
  onAdd: (material: OplIssuedItemMaterial) => void
  picked: OplIssuedItemMaterial[]
}
 ...
 */
const OplMaterialTransferTable = ({ fromLocationId, onAdd, picked }: Props) => {
   ...
   */
  const warehouseQuery = trpc.opl.warehouse.getAll.useQuery(
    { locationId: fromLocationId!, itemType: 'MATERIAL' },
    { enabled: !!fromLocationId }
  )

  const technicianQuery = trpc.opl.warehouse.getTechnicianStock.useQuery(
...
export default OplMaterialTransferTable
