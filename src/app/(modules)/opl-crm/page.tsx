//scr/app/(modules)/opl-crm/page.tsx
...
export default function VectraCrmEntryPage() {
  ...
  useEffect(() => {
    ...
    if (role === 'ADMIN' || role === 'COORDINATOR') {
      router.replace('/opl-crm/admin-panel')
      return
    }

    if (role === 'WAREHOUSEMAN') {
      router.replace('/opl-crm/admin-panel?tab=warehouse')
      return
    }

    if (role === 'TECHNICIAN') {
      router.replace('/opl-crm?tab=dashboard')
      return
    }
