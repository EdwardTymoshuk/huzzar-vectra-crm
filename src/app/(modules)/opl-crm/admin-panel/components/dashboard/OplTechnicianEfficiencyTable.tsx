...
const OplTechnicianEfficiencyTable = ({ date, range, orderType }: Props) => {
  const { data, isLoading, isError } =
    trpc.opl.order.getTechnicianEfficiency.useQuery({
...
export default OplTechnicianEfficiencyTable
