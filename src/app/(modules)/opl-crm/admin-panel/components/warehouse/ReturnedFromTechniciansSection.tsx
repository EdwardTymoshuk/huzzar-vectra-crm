...
const ReturnedFromTechniciansSection = () => {
  ...
  //   trpc.opl.warehouse.generateReturnToOperatorReport.useMutation()
  ...
  const returnMutation = trpc.opl.warehouse.returnToOperator.useMutation({
    onSuccess: async (res) => {
      ...
      utils.opl.warehouse.getReturnedFromTechnicians.invalidate()
                            ...
                            {collected ? (
                              <>
                                <span className="text-sm break-all">
                                  Odebrał: {collected.performedBy.user.name}
                                </span>
